...
$_['quickcheckout_settings'] = array('general' => array(
									'enable' => 1,
									'min_order' => array('value' => 500, 'text' => array(1 => 'You must have a sum more then %s to make an order ')),
									'main_checkout' => 1,
									'column_width' => array(1 => '50', 2 => '50', 3 => '0'),
                                ...
                                'middlename' => array(
                                  'id' => 'middlename',
                                   'title' => 'entry_middlename', 
                                   'tooltip' => '',
                                   'error' => array(0 => array('min_length' => 3, 
                                                 'max_length' => 32, 
                                                 'text' => 'error_middlename')),
                                   'type' => 'text',
                                   'refresh' => '0',
                                   'custom' => 0,
                                   'display' => 0,
                           ...
                           'identity_card_number' => array(
                                  'id' => 'identity_card_number',
                                   'title' => 'entry_identity_card_number', 
                                   'tooltip' => '',
                                   'error' => array(0 => array('min_length' => 3, 
                                                 'max_length' => 32, 
                                                 'text' => 'error_identity_card_number')),
                                   'type' => 'text',
                                   'refresh' => '0',
                                   'custom' => 0,
                                   'display' => 0,
                              ...
                              'mobile_phone' => array(
                                  'id' => 'mobile_phone',
                                   'title' => 'entry_mobile_phone', 
                                   'tooltip' => '',
                                   'error' => array(0 => array('min_length' => 3, 
                                                 'max_length' => 32, 
                                                 'text' => 'error_mobile_phone')),
                                   'type' => 'text',
                                   'refresh' => '0',
                                   'custom' => 0,
                                   'display' => 0,
