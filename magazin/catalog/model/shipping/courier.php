		...
		if ($status) {
			$quote_data = array();
      		...
      		$quote_data['courier'] = array(
				...
				'text'         => $this->currency->format($this->tax->calculate($this->config->get('courier_cost'), $this->config->get('courier_tax_class_id'), $this->config->get('config_tax')))//$this->currency->format(0.00)
      		);
