    ...
    <div id="<?php echo $field['id']; ?>_input" class="box box-border sort-item <?php echo $field['id']; ?> <?php echo ($field['class'])? $field['class'] : ''; ?>" sort-data="<?php echo $field['sort_order']; ?>">
      ...
      <div class="box-content">
        ...
        <?php
    		...
    		case "checkbox":
		?>
        <div id="<?php echo $field['id']; ?>_input" class="checkbox-input sort-item <?php echo (!$field['display'])? 'hide' : ''; ?> <?php echo ($field['class'])? $field['class'] : ''; ?>" sort-data="<?php echo $field['sort_order']; ?>" style="<?php if ( strpos($_SERVER['SERVER_NAME'], 'akata') || $b2b ) echo "display:none"; ?>">
        <?php if($field['value'] == 1 || strpos($_SERVER['SERVER_NAME'], 'akata') || $b2b ){?>
