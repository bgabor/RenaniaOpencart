<div id="cart">
  <div class="heading">
   <span class="cart"> <a href="<?php echo $cart; ?>"><?php echo $heading_title; ?></a></span>
    <a href="<?php echo $cart; ?>"><span id="cart-total"><?php echo $text_items; ?></span></a>
    <a href="<?php echo $cart; ?>" class="cart-image-container">
        <img src="catalog/view/theme/default/image/cos.png">
    </a>
  </div>
   <!--
  <div class="content">
