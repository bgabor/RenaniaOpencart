...
<style type="text/css">
br.clear {clear:both;}
#dream_column_header_bottom {width:100%;position:relative;overflow:hidden;}
#dream_column_header_bottom .row {width:100%;display:block;position:relative;}
#dream_column_header_bottom .row .col {display:block;position:relative;float:left;}
</style>
<div id="dream_column_header_bottom">
