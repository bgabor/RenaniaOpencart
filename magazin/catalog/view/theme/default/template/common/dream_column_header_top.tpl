...
<style type="text/css">
br.clear {clear:both;}
#dream_column_header_top {width:100%;position:relative;overflow:hidden;}
#dream_column_header_top .row {width:100%;display:block;position:relative;}
#dream_column_header_top .row .col {display:block;position:relative;float:left;}
</style>
<div id="dream_column_header_top">
