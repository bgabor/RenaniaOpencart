    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php if ($products[$product['product_id']]['price']) { ?>
          ...
          <?php echo (float)$products[$product['product_id']]['price'] != 0 ? $products[$product['product_id']]['price'] : $text_price_ask; ?>
          <?php } else { ?>
          <span class="price-old"><?php echo (float)$products[$product['product_id']]['price'] != 0 ? $products[$product['product_id']]['price'] : $text_price_ask; ?></span>
