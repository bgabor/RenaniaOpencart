...
class ControllerAccountB2BBankAccount extends Controller
{
    ...
    public function insert()
    {
        ...
        $this->load->model( 'invoice/bank_acount' );

        if( ($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm() )
        {
            $this->model_invoice_address->addBankAccount( $this->request->post, $this->customer->getAxCode() );
...
/*    public function update()
    ...
    public function delete()
    {
        ...
        if( isset( $this->request->get['accountnum'] ) && isset( $this->request->get['iban'] ) && $this->validateDelete( $this->request->get['accountnum'] ) )
        {
            $this->model_invoice_bank_account->deleteBankAccount( $this->request->get['accountnum'], $this->request->get['iban'] );

            $this->session->data['success'] = $this->language->get( 'text_delete_bank_account' );
...
//        }
    ...
    protected function validateDelete( $customer_ax_code )
    {
        if( $this->model_invoice_bank_account->getTotalBankAccounts( $customer_ax_code ) == 1 )
        {
