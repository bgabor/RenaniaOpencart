...
class ControllerModuleFilterPro extends Controller
{
    ...
    protected function index( $setting )
    {
        ...
        else
        {
            ...
            //$this->data['instock_checked'] = isset( $filt erpro_setting['instock_checked'] ) ? 1 : 0;
            $this->data['instock_checked'] = empty( $filterpro_setting['instock_checked'] ) ? 0 : 1;
...
/*		if( $_SERVER['REMOTE_ADDR'] == '188.26.23.46' ){
			print "aaaaaaaaaaaaaaaaaaaaa=".$product_total ;
			die();
		}*/
