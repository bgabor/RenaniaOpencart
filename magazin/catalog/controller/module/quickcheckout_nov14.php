...
//            // end ax
	...
	/*
    private function saveApiMessage( $xml )
    {
        ...
        $this->sendXmlToUser( $xml, $file_name );
    }
	*/
...
//                        }
                        ...
                        if ( $result['code'] != 'courier' ) //if ( $result['code'] != 'courier' )
                        {
...
//                        }
//                        else
                        if ( $result['code'] == 'courier' || $result['code'] == 'free' ) 
                        {
