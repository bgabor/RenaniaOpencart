...
class ControllerProductStoreOrdersReport extends Controller
{
    ...
    public function index()
    {
        ...
        $SQL .= "SELECT oco.order_id, oco.firstname,oco.lastname,oco.payment_company,oco.shipping_address_1,oco.shipping_address_2,oco.shipping_zone,
                     oco.shipping_postcode,oco.shipping_method, oco.shipping_city, oco.date_added, oco.order_status_id,   ";
        ...
        $SQL .= " JOIN  oc_customer AS occ ON occ.customer_id =  oco.customer_id"; // LEFT JOIN
        //print $SQL;die();
        ...
        */
        ...
        foreach ( $order_info as $info ) 
        {
            $this->db->query("INSERT INTO online_shop_orders SET order_id = '" . $info['order_id'] . "', 
