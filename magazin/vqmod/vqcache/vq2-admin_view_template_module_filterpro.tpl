	...
	<td>
		<table class="list" style="width: 600px; float: left">
			...
			<tr>
				...
				<td><input type="checkbox" name="filterpro_setting[theme_mega]" id="theme_mega">
				</td>
			</tr>
...
<?php echo $text_filter_position; ?>
      <table id="module" class="list">
        ...
        <?php echo $module['extra_position_html']; ?>
                ...
                <?php } ?>
                <?php if ($module['position'] == 'inside_categories') { ?>
                <option value="inside_categories" selected="selected"><?php echo "inside_categories"; ?></option>
                <?php } else { ?>
                <option value="inside_categories"><?php echo "inside_categories"; ?></option>
                <?php } ?>
              </select></td>
