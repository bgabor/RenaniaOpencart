    ...
    <div class="content">
      <table class="form">
        ...
        <tr>
                ...
                <td><span class="required">*</span><?php echo $entry_identity_card_number; ?></td>
...
<script type="text/javascript"><!--
      ...
      /*$('input[name=\'tax_id\']').bind('change', function() {

            var tax_id_value = $(this).attr('value');
            var posRO = tax_id_value.indexOf("RO"); 
            var tax_id = 0;
            if ( posRO == -1 )
            {
               tax_id = tax_id_value;
            ...
            {
               tax_id = tax_id_value.substring( 2 );
            }            
            
            $.ajax({
            type: 'get',
            url: 'http://openapi.ro/api/companies/'+  tax_id +'.json',
            dataType: 'jsonp',
            success: function(data) {
               $('input[name=\'company\']').val ( data['name'] );
               $('input[name=\'company_id\']').val ( data['registration_id'] );
               $('input[name=\'address_1\']').val ( data['address'] );
               $('input[name=\'city\']').val ( data['city'] );
               $('input[name=\'postcode\']').val ( data['zip'] );
               ...
               $.ajax({               
                  ...
                  success: function( response ) {
                     ...
                     if ( response )
                     {                        
                        $("select[name=\'zone_id\'] option[value='"+ response['zone_id']  +"']").attr("selected","selected");
                     }
                  },
                  failure: function(){},
                  error: function(){}
   ...
   $('input[name=\'tax_id\']').bind('change', function() {
            ...
            $.ajax({
            type: 'get',
            url: 'index.php?route=account/register/verificationVat&cui=' + tax_id,
            dataType: 'json',
            success: function(data) {
