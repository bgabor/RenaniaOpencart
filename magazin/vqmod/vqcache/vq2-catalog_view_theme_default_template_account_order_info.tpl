  ...
  <table class="list">
    <thead>
      <tr>
        ...
        <?php if ($products) { ?>
              <td style="width: 1px;"><a href="<?php echo $return_order; ?>"><img src="catalog/view/theme/default/image/return.png" alt="<?php echo $button_return; ?>" title="<?php echo $button_return; ?>" /></a></td>
        <?php } ?>
      </tr>
    </thead>
    <tbody>
    ...
    <tfoot>
      ...
      <?php if (strpos($_SERVER['SERVER_NAME'], 'akata') && $total['code'] == 'shipping') { ?>
