  ...
  <div class="product-info <?php echo $this->journal2->settings->get('split_ratio'); ?>" data-respond="start: 620px; end: 630px; interval: 10px;">
    ...
    <?php endforeach; ?>
      <div class="description">
        ...
        <?php } ?>
        <span class="p-stock"><?php echo $text_stock; ?></span> <span class="journal-stock <?php echo isset($stock_status) ? $stock_status : ''; ?>"><span id="myoc-lpu-stock"><?php echo $stock; ?></span></span>
      </div>
    ...
    <?php if (isset($date_end) && $date_end && $this->journal2->settings->get('show_countdown_product_page', 'on') == 'on'): ?>
      ...
      <div class="price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
        ...
        <?php endif; ?>
        <?php if (!$special) { ?>
        <span class="product-price" itemprop="price"><span id="myoc-lpu-price"><?php echo $price; ?></span></span>
        <?php } else { ?>
        <span class="price-old"><span id="myoc-lpu-price"><?php echo $price; ?></span></span> <span class="price-new" itemprop="price"><span id="myoc-lpu-special"><?php echo $special; ?></span></span>
        <?php } ?>
        <?php if ($tax) { ?>
        <span class="price-tax"><?php echo $text_tax; ?> <span id="myoc-lpu-extax"><?php echo $tax; ?></span></span>
        <?php } ?>
        <?php if ($points) { ?>
      ...
      <div class="options <?php echo $this->journal2->settings->get('product_page_options_push_classes'); ?>">
        ...
        <?php } ?>
          ...
          <a id="elso_group"><span><?php echo $text_see_corresponding_size; ?></span></a>
          <div id="dialog" title="<?php echo $text_see_corresponding_size; ?>" style="display: none;">
              <img src="catalog/view/theme/default/image/size_chart/<?php echo $product_size_chart; ?>" />
          </div>
          <?php } ?>
      </div>
