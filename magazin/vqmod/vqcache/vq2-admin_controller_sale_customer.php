...
//                   $customer_security_code = mb_substr(mt_rand(), 0, 10);
    ...
    protected function getForm()
    {
        ...
        $this->data['entry_ax_code'] = $this->language->get( 'entry_ax_code' );
        //$this->data['entry_payment_term'] = $this->language->get( 'entry_payment_term' );
 ...
 $this->data['have_api_access'] =  0;  
        ...
        elseif( !empty( $customer_info ) )
        {
            $this->data['ax_code'] = $customer_info['ax_code'];
        }
        else
        {
            $this->data['ax_code'] = '';
        ...
        elseif( !empty( $customer_info ) )
        {
            $this->data['permission'] = $customer_info['permission'];
        }
        else
        {
...
//        {
//            $this->data['payment_term'] = $this->request->post['payment_term'];
//        }
//        elseif( !empty( $customer_info ) )
//        {
//            $this->data['payment_term'] = substr ( $customer_info['payment_term'], 0, 10);
//        }
//        else
//        {
...
//        }
        ...
        {
               if($customer_info['customer_group_id'] == 3 || $customer_info['customer_group_id'] == 4) {
