		...
		if ($order_info && !$order_info['order_status_id']) {
			...
			foreach ($order_product_query->rows as $order_product) {
                ...
                $this->db->query("UPDATE " . DB_PREFIX . "product_option_value
                                    ...
                                    AND subtract = '1'
                                    AND quantity >= " . (int)$order_product['quantity'] . ";");
