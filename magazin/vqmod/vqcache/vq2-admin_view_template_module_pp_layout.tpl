    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <?php echo $module['extra_position_html']; ?>
              ...
              <td class="right"><input type="text" name="pp_layout_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
...
function addModule() {	
    ...
    html += '    </select></td>';
	html += '    <td class="right"><input type="text" name="pp_layout_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
