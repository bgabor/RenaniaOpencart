...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_setting_email_addresses'] = $this->language->get('text_setting_email_addresses');
      ...
      $this->data['useful_document'] = $this->url->link('catalog/useful_document', 'token=' . $this->session->data['token'], 'SSL');
      $this->data['reclamation'] = $this->url->link('catalog/reclamation', 'token=' . $this->session->data['token'], 'SSL');
      $this->data['setting_email_addresses'] = $this->url->link('catalog/setting_email_address', 'token=' . $this->session->data['token'], 'SSL');
