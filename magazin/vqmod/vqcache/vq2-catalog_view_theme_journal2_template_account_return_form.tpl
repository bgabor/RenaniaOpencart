...
<div id="content" class="returns"><h1 class="heading-title"><?php echo $heading_title; ?></h1><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <?php } ?>
        ...
        <br />
        <?php if (isset($error_text_location) && $error_text_location) { ?>
    ...
    <div class="return-product" line="<?php echo $i; ?>">
        <div class="content xs-100 sm-100 md-70 lg-80 xl-80">

            <div class="return-model xs-100 sm-50 md-20 lg-20 xl-20"><b><?php echo $entry_model; ?></b><br />
            ...
            <div class="return-color xs-100 sm-50 md-20 lg-20 xl-20"><b><?php echo $entry_color; ?></b><br />
            ...
            <div class="return-size xs-100 sm-50 md-20 lg-20 xl-20"><b><?php echo $entry_size; ?></b><br />
            ...
            <div class="return-config xs-100 sm-50 md-20 lg-20 xl-20"><b><?php echo $entry_config; ?></b><br />
            ...
            <div class="return-quantity xs-100 sm-50 md-20 lg-20 xl-20"><b><?php echo $entry_quantity; ?></b><br />
            ...
            <div class="return-opened xs-100 sm-50 md-20 lg-20 xl-20"><b><?php echo $entry_opened; ?></b><br />
            ...
            <div class="return-reason xs-100 sm-50 md-20 lg-20 xl-20"><b><?php echo $entry_reason; ?></b><br />
            ...
            <div class="return-fault-details xs-100 sm-50 md-60 lg-60 xl-60"><b><?php echo $entry_fault_detail; ?></b><br />
                <textarea name="products[<?php echo $i; ?>][comment]"><?php echo $products[$i]['comment']; ?></textarea>
            </div>

        </div>
        <div class="return_add_new_line xs-100 sm-100 md-30 lg-20 xl-20">
...
$(document).ready(function() {
    ...
    $('.btn-one-more-row').live( "click", function() {
	    ...
	    $('.return-product').last().after('<div line="'+new_line_nr+'" class="return-product"> <div class="content xs-100 sm-100 md-70 lg-80 xl-80"> <div class="return-model xs-100 sm-50 md-20 lg-20 xl-20"><b>Cod produs:</b><br><input type="text" value="" name="products['+new_line_nr+'][model]"> <br></div><div class="return-color xs-100 sm-50 md-20 lg-20 xl-20"><b>Culoare:</b><br><input type="text" value="" name="products['+new_line_nr+'][color]"> <br></div><div class="return-size xs-100 sm-50 md-20 lg-20 xl-20"><b>Marime:</b><br><input type="text" value="" name="products['+new_line_nr+'][size]"> <br></div><div class="return-config xs-100 sm-50 md-20 lg-20 xl-20"><b>Configuratie:</b><br><input type="text" value="" name="products['+new_line_nr+'][config]"> <br></div><div class="return-quantity xs-100 sm-50 md-20 lg-20 xl-20"><b>Cantitate:</b><br><input type="text" value="1" name="products['+new_line_nr+'][quantity]"> <br></div><div class="return-opened xs-100 sm-50 md-20 lg-20 xl-20"> <b>Produs desigilat:</b><br><div style="margin-top:10px;"> <input type="radio" id="opened" value="1" name="products['+new_line_nr+'][opened]"> <label for="opened">Da</label> <input type="radio" checked="checked" id="unopened" value="0" name="products['+new_line_nr+'][opened]"> <label for="unopened">Nu</label> <br><br></div></div><div class="return-reason xs-100 sm-50 md-20 lg-20 xl-20"> <b>Motiv retur:</b><br><select name="products['+new_line_nr+'][return_reason_id]"> <option selected="selected">Alegeti motivul</option> <option id="return-reason-id5" value="5">Alte cauze, va rugam detaliati</option> <option id="return-reason-id3" value="3">Eroare la comanda</option> <option id="return-reason-id1" value="1">Produs nou, defect</option> <option id="return-reason-id4" value="4">Produs utilizat, defect</option> <option id="return-reason-id2" value="2">Produse livrate gresit</option> <option id="return-reason-id6" value="6">Schimbare marime/culoare</option> </select> </div><div class="return-fault-details xs-100 sm-50 md-60 lg-60 xl-60"><b>Detalii:</b><br><textarea rows="1" cols="17" name="products['+new_line_nr+'][comment]"></textarea> </div></div><div class="return_add_new_line xs-100 sm-100 md-30 lg-20 xl-20"> <a class="btn-one-more-row" href="javascript:void(0)">Adauga linie noua</a><br><br><br><a href="javascript:void(0)" class="btn-remove-one-row"><?php echo $text_remove_one_row; ?></a> </div></div>');
    });
