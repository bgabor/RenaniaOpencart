...
class ControllerShippingCourier extends Controller {
	...
	public function index() {   
		$this->language->load('shipping/courier');
    ...
    if (isset($this->request->post['courier_cost'])) {
			$this->data['courier_cost'] = $this->request->post['courier_cost'];
		} else {
			$this->data['courier_cost'] = $this->config->get('courier_cost');
		}
    
    if (isset($this->request->post['courier_tax_class_id'])) {
			$this->data['courier_tax_class_id'] = $this->request->post['courier_tax_class_id'];
		} else {
			$this->data['courier_tax_class_id'] = $this->config->get('courier_tax_class_id');
		}
