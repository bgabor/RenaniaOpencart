...
class ControllerShippingFree extends Controller {
	...
	public function index() {   
		...
		$this->data['entry_total_b2b'] = $this->language->get('entry_total_b2b');
		...
		if (isset($this->request->post['free_total_b2b'])) {
			$this->data['free_total_b2b'] = $this->request->post['free_total_b2b'];
		} else {
			$this->data['free_total_b2b'] = $this->config->get('free_total_b2b');
		}
