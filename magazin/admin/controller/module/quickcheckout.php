...
class ControllerModuleQuickcheckout extends Controller {
	...
	public function index() {   
		...
		$this->document->addStyle('view/javascript/quickcheckout/uniform/css/uniform.default.css');
		
		
		$this->document->addScript('view/javascript/quickcheckout/tinysort/jquery.tinysort.min.js');	
		$this->document->addScript('view/javascript/quickcheckout/jquery/jquery.autosize.min.js');	
		$this->document->addScript('view/javascript/quickcheckout/uniform/jquery.uniform.min.js');
		...
		$this->document->addScript('view/javascript/quickcheckout/tooltip/tooltip.js');
		...
		$this->data['text_home_h2'] = $this->language->get('text_home_h2');
