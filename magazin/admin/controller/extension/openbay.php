...
class ControllerExtensionOpenbay extends Controller {
    ...
    public function itemList() {        
     ...
     public function populateMailContent()
    {
        $this->load->model( 'sale/order' );
        $totals = $this->model_sale_order->getOrderTotals( $this->request->get['order_id'] );
        $delivery_method = $totals[1]['title'];
        if ( sizeof($totals) == 3 )
        {
            $total = $totals[2]['text'];
        }
        else  if ( sizeof($totals) > 3 )
        {
             $total = $totals[3]['text'];
        }
...
//                }
        ...
        if( $this->request->get['status_id'] == 15 ) // processed
        {
            $mail_content = $this->language->get( 'processed_mail_comment' );
        }
