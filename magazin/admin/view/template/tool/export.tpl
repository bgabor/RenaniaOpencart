        ...
        <table class="form">
          ...
          <tr>
            <td width="35%">
                <table>
                    <tr>
                        <td><?php echo $entry_restore; ?></td><td><input type="radio" name="import_type_radio" value="<?php echo $const_imp_backup;?>"></td>
                    </tr>
                    <tr>
                        <td><?php echo $entry_imp_prod; ?></td><td><input type="radio" name="import_type_radio" value="<?php echo $const_imp_prod;?>"></td>
                    </tr>
                    <tr>
                        <td><?php echo $entry_imp_prod_o; ?></td><td><input type="radio" name="import_type_radio" value="<?php echo $const_imp_prod_o;?>"></td>
                    </tr>
                    <tr>
                        <td><?php echo $entry_imp_prod_o_comb; ?></td><td><input type="radio" name="import_type_radio" value="<?php echo $const_imp_prod_o_c;?>"></td>
                    </tr>
                </table>
            </td>
