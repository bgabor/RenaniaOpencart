      ...
      <thead>
         <tr>
           <td class="left">
              ...
              <?php echo $entry_status; ?>: <?php echo $recl_status; ?> <br>
...
<!--               <?php if ( $history['customer_id'] == '-99999' ) { ?>
               ...
               <tr>
                  <td <?php  if ( ($key +1 ) % 2 == 0  ) {  ?> style="background-color: #EFEFEF" <?php } ?> colspan="2" valign="top" class="left"> 
                     <?php echo $text_insert_date; ?>: <?php echo $history['insert_date']; ?></td>
               </tr>
<!--               <tr>
                  <td <?php  if ( ($key +1 ) % 2 == 0  ) {  ?> style="background-color: #EFEFEF" <?php } ?> colspan="2" valign="top" class="left"> 
                     <?php echo $text_status; ?>: <?php echo $history['status']; ?></td>
               </tr>-->
               <tr>
                  <td <?php  if ( ($key +1 ) % 2 == 0  ) {  ?> style="background-color: #EFEFEF" <?php } ?> colspan="2" valign="top" class="left"> 
                     <?php echo $entry_description; ?>: <?php echo $history['description']; ?></td>
               </tr>
               <tr>
            ...
            <td colspan="2">
               ...
               <div>
                  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                     ...
                     <table class="form">
                        <tr>
                           <td class="left" valign="top" style="width: 50%"><span class="required">*</span> <?php echo $entry_number; ?></td>
                           <td class="left" style="width: 50%">
                              <input type="text" id="number" name="number" value="<?php echo $number; ?>" <?php echo $attribute; ?>/>
                              <?php if ($error_number) { ?>
                              <span class="error"><?php echo $error_number; ?></span>
                              <?php } ?></td>
                        </tr>
                        <tr>
                           <td class="left" style="width: 50%" valign="top"><span class="required">*</span> <?php echo $entry_description; ?></td>
                           <td class="left" style="width: 50%">
                        ...
                        <tr>
                           <td class="left" valign="top" style="width: 50%">
                              <?php echo $entry_documents; ?></td>
                           <td class="left" align="left" style="width: 50%">
                        ...
                        <tr>
                           <td class="left" valign="top" style="width: 50%"> <?php echo $entry_status; ?>:</td>
                           <td class="left" style="width: 50%">
