      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($document['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $document['name']; ?></td>
              <td class="right"><?php echo $document['sort_order']; ?></td>
              <td class="right"><?php foreach ($document['action'] as $action) { ?>
