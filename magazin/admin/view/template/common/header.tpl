    ...
    <ul class="left" style="display: none;">
      ...
      <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $useful_document; ?>"><?php echo $text_useful_documents; ?></a></li>
          <li><a href="<?php echo $reclamation; ?>"><?php echo $text_reclamation; ?></a></li>
          <li><a href="<?php echo $setting_email_addresses; ?>"><?php echo $text_setting_email_addresses; ?></a></li>
        </ul>
      </li>
