        ...
        <accordion-group is-open="accordion.accordions[2]">
            ...
            <ul class="module-create-options">
                ...
                <accordion-group is-open="false">
                    <accordion-heading>
                        <div class="accordion-bar bar-level-1">View Order / Reorder / Return Buttons <span>Opencart 2.x only</span></div>
                    </accordion-heading>
                    <ul class="module-create-options">
                        <li>
                    ...
                    <ul class="module-create-options">
                        ...
                        <li>
                            <span class="module-create-title">Checkout Hover Color</span>
                                <span class="module-create-option">
                                    <j-opt-color data-ng-model="settings.cart_page_checkout_button_color_hover"></j-opt-color>
                                </span>
                            <a href="#" target="_blank" class="journal-tip"> </a>
                        </li>
                        <li>
                            <span class="module-create-title">Checkout Background Color</span>
                                <span class="module-create-option">
                                    <j-opt-color data-ng-model="settings.cart_page_checkout_button_bg_color"></j-opt-color>
                                </span>
                            <a href="#" target="_blank" class="journal-tip"> </a>
                        </li>
                        <li>
                            <span class="module-create-title">Checkout Background Hover Color</span>
                                <span class="module-create-option">
                                    <j-opt-color data-ng-model="settings.cart_page_checkout_button_bg_hover_color"></j-opt-color>
                                </span>
                            <a href="#" target="_blank" class="journal-tip"> </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <span class="module-create-title">Continue Shopping Hover Color</span>
                                <span class="module-create-option">
                                    <j-opt-color data-ng-model="settings.cart_page_continue_button_color_hover"></j-opt-color>
                                </span>
                            <a href="#" target="_blank" class="journal-tip"> </a>
                        </li>
                        <li>
                            <span class="module-create-title">Continue Shopping Background Color</span>
                                <span class="module-create-option">
                                    <j-opt-color data-ng-model="settings.cart_page_continue_button_bg_color"></j-opt-color>
                                </span>
                            <a href="#" target="_blank" class="journal-tip"> </a>
                        </li>
                        <li>
                            <span class="module-create-title">Continue Shopping Background Hover Color</span>
                                <span class="module-create-option">
                                    <j-opt-color data-ng-model="settings.cart_page_continue_button_bg_hover_color"></j-opt-color>
                                </span>
                            <a href="#" target="_blank" class="journal-tip"> </a>
                        </li>
                        <li>
                    ...
                    <accordion-group is-open="false">
                        ...
                        <ul class="module-create-options">
                            ...
                            <li>
                                ...
                                <span class="module-create-option">
                                    <j-opt-color data-ng-model="settings.checkout_confirm_button_color_hover"></j-opt-color>
                                </span>
                                <a href="#" target="_blank" class="journal-tip"> </a>
                            </li>
                            <li>
                                <span class="module-create-title">Background Color</span>
                                <span class="module-create-option">
                                    <j-opt-color data-ng-model="settings.checkout_confirm_button_bg_color"></j-opt-color>
                                </span>
                                <a href="#" target="_blank" class="journal-tip"> </a>
                            </li>
                            <li>
                                ...
                                <span class="module-create-option">
                                    <j-opt-color data-ng-model="settings.checkout_confirm_button_bg_hover_color"></j-opt-color>
                                </span>
                                <a href="#" target="_blank" class="journal-tip"> </a>
                            </li>
                            <li>
