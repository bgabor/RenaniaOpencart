                ...
                return [
                    {
                        ...
                        transitions: [
                            ...
                            { name: 'Slide Slots Horizontal', id: 'slotfade-horizontal' },
                            { name: 'Slide Slots Vertical', id: 'slotfade-vertical' },
                        ...
                        $modal.open({
                            ...
                            controller: function($scope, ngModel, $modalInstance) {
                                ...
                                $scope.fontChanged = function(font) {
                                    ...
                                    if ($scope.font_weights.length && _.indexOf($scope.font_weights, font.font_weight) === -1) {
