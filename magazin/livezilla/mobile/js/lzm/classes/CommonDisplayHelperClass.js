...
CommonDisplayHelperClass.prototype.createSelect = function(myId, myClass, myAction, myText, myIcon, myCss, myTitle, myOptionList, mySelectedOption) {
    ...
    myClass = (typeof myClass != 'undefined') ? ' class="chat-select "' + myClass + '"' : ' class="chat-select"';
    myAction = (typeof myAction != 'undefined' && myAction != '') ? ' onclick="' + myAction + '"' : '';
    myCss = (typeof myCss != 'undefined') ? myCss : {};
    myTitle = (typeof myTitle != 'undefined') ? ' title="' + myTitle + '"' : '';
    ...
    var selectCss = ' style=\'white-space: nowrap; cursor: pointer; background-image: ' + this.addBrowserSpecificGradient('') +
    ...
    var selectText = '';
    if (myOptionList.length > mySelectedOptionIndex && typeof myOptionList[mySelectedOptionIndex].icon != 'undefined') {
        var iconPosition = (myIcon == 'left') ? ' left: 0px;' : ' right: 0px;';
        selectTextCss = (myIcon == 'left') ? ' style="padding-left: 30px; font-size: 14px;"' :
            (!myIcon) ? ' style="font-size: 12px;"' : ' style="padding-right: 30px; font-size: 14px;"';
        selectInnerCss = (myIcon == 'left') ? ' style="text-align: left; padding-top: 3px;"' :
            (!myIcon) ? ' style="text-align: center; padding-top: 3px;"' : ' style="text-align: right; padding-top: 3px;"';
        selectIconCss += ' style=\'background-image: url("' + myOptionList[mySelectedOptionIndex].icon + '");' + iconPosition + ' top: -3px;\';';
