...
ChatUserActionsClass.prototype.saveTranslationSettings = function(visitorChat, tmm, tvm) {
    ...
    if ((tmm.translate && tmm.sourceLanguage != tmm.targetLanguage) || (tvm.translate && tvm.sourceLanguage != tvm.targetLanguage)) {
        $('#translate-chat').css({'background-image': lzm_displayHelper.addBrowserSpecificGradient('', 'blue'), color: '#ffffff'});
    } else {
        $('#translate-chat').css({'background-image': lzm_displayHelper.addBrowserSpecificGradient(''), color: '#333333'});
    }
};
