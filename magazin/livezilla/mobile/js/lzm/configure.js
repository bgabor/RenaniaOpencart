...
$(document).ready(function () {
    ...
    var profileButtonHtml = lzm_displayHelper.createButton('new_profile_btn', '', '', t('New profile'), 'img/043-doc_add.png', 'lr',
        {'margin-right': '10px', 'padding-left': '5px', 'padding-right': '5px'}, '') +
        lzm_displayHelper.createButton('edit_profile_btn', 'change-config ui-disabled', '', t('Edit profile'), 'img/048-doc_edit.png', 'lr',
            {'margin-right': '10px', 'padding-left': '5px', 'padding-right': '5px'}, '') +
        lzm_displayHelper.createButton('del_profile_btn', 'change-config ui-disabled', '', t('Delete profile'), 'img/044-doc_delete2.png', 'lr',
            {'padding-left': '5px', 'padding-right': '5px'}, '') +
        '<hr style="margin-top: 15px;">';
    $('#profile_buttons').html(profileButtonHtml).trigger('create');
    var configureButtonHtml = lzm_displayHelper.createButton('save_profile', 'ui-disabled', '', t('Save profile'), '', 'lr', {'margin-right': '10px'}, '') +
            lzm_displayHelper.createButton('back_btn', '', '', t('Ok'), '', 'lr', {}, '');
    ...
    $('#new_profile_btn').click(function () {
        ...
        $('#edit_profile_form').css('display', 'none');
        $('#save_profile').removeClass('ui-disabled');
    ...
    $('#del_profile_btn').click(function () {
        ...
        $('#save_profile').addClass('ui-disabled');
        $('#back_btn').html(t('Ok'));
        lzm_commonDisplay.resizeConfigPage();
    });
