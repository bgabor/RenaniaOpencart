...
{
    if(lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0',"lz_chat_file_frame").style.height.toString().replace("px",'') != "0")
        return true;
    if(lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0',"lz_chat_feedback_frame").style.height.toString().replace("px",'') != "0")
        return true;
    if(lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0',"lz_chat_emoticons_frame").style.height.toString().replace("px",'') != "0")
        return true;
    if(lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0',"lz_chat_com_frame").style.height.toString().replace("px",'') != "0")
        return true;
    if(lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0',"lz_chat_auto_translate_frame").style.height.toString().replace("px",'') != "0")
        return true;
    if(lz_chat_get_frame_object('lz_chat_frame.3.2.chat.5.0',"lz_chat_transcript_frame").style.height.toString().replace("px",'') != "0")
        return true;
}
